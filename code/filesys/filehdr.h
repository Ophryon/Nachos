...
//32-2-1=29个直接索引，第29个是间接索引
#define NumDataSectors (SectorSize - 2 * sizeof(int)-(6+26)) / sizeof(int)
#define NumDirect 	((SectorSize - 2 * sizeof(int)-(6+26)) / sizeof(int) - 1)
